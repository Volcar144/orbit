...
export type StorageHash =
  StorageHashBase<'6a031695a32d2b66c5137c1b8da81ffc7748613d9ac28ad5df4e7dcec2a8fbc2'>;
export type ExecutionHash =
  ExecutionHashBase<'83c079ea6c60c6ad110a4be98ba3170a8111e3a8340c677939e875223b1a231c'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Comment: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly posterId: CodecTypes['pg/text@1']['output'];
      readonly postId: CodecTypes['pg/text@1']['output'];
      readonly repliedToId: CodecTypes['pg/text@1']['output'] | null;
      readonly content: CodecTypes['pg/text@1']['output'];
      readonly image: CodecTypes['pg/text@1']['output'] | null;
      readonly postedAt: CodecTypes['pg/timestamptz@1']['output'];
      readonly editedAt: CodecTypes['pg/timestamptz@1']['output'];
      readonly likes: CodecTypes['pg/int4@1']['output'];
    };
    readonly Post: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly sourceApi: CodecTypes['pg/text@1']['output'];
      readonly externalDate: CodecTypes['pg/date@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Comment: {
      readonly id: CodecTypes['pg/text@1']['input'];
      readonly posterId: CodecTypes['pg/text@1']['input'];
      readonly postId: CodecTypes['pg/text@1']['input'];
      readonly repliedToId: CodecTypes['pg/text@1']['input'] | null;
      readonly content: CodecTypes['pg/text@1']['input'];
      readonly image: CodecTypes['pg/text@1']['input'] | null;
      readonly postedAt: CodecTypes['pg/timestamptz@1']['input'];
      readonly editedAt: CodecTypes['pg/timestamptz@1']['input'];
      readonly likes: CodecTypes['pg/int4@1']['input'];
    };
    readonly Post: {
      readonly id: CodecTypes['pg/text@1']['input'];
      readonly sourceApi: CodecTypes['pg/text@1']['input'];
      readonly externalDate: CodecTypes['pg/date@1']['input'];
...
export type StorageColumnTypes = {
  readonly public: {
    ...
    readonly posts: {
      ...
      readonly external_date: CodecTypes['pg/date@1']['output'];
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly image_url: CodecTypes['pg/text@1']['output'] | null;
      readonly likes: CodecTypes['pg/int4@1']['output'];
      readonly source_api: CodecTypes['pg/text@1']['output'];
      readonly title: CodecTypes['pg/text@1']['output'];
    };
    readonly session: {
      readonly createdAt: CodecTypes['pg/timestamptz@1']['output'];
...
export type StorageColumnInputTypes = {
  readonly public: {
    ...
    readonly posts: {
      ...
      readonly external_date: CodecTypes['pg/date@1']['input'];
      readonly id: CodecTypes['pg/text@1']['input'];
      readonly image_url: CodecTypes['pg/text@1']['input'] | null;
      readonly likes: CodecTypes['pg/int4@1']['input'];
      readonly source_api: CodecTypes['pg/text@1']['input'];
      readonly title: CodecTypes['pg/text@1']['input'];
    };
    readonly session: {
      readonly createdAt: CodecTypes['pg/timestamptz@1']['input'];
          ...
          readonly table: {
            ...
            readonly comment: {
              ...
              indexes: readonly [
                ...
                {
                  readonly name: 'comment_posterId_idx_981844b1';
                  readonly prefix: 'comment_posterId_idx';
                  readonly columns: readonly ['posterId'];
                  readonly unique: false;
                },
                {
                  readonly name: 'comment_repliedToId_idx_9203da51';
                  readonly prefix: 'comment_repliedToId_idx';
                  readonly columns: readonly ['repliedToId'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
            ...
            readonly posts: {
              ...
              primaryKey: { readonly columns: readonly ['id'] };
              uniques: readonly [{ readonly columns: readonly ['source_api', 'external_date'] }];
              indexes: readonly [];
              foreignKeys: readonly [];
            };
            readonly session: {
        ...
        readonly models: {
          ...
          readonly Comment: {
            ...
            readonly relations: {
              ...
              readonly poster: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['posterId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly repliedTo: {
                ...
                readonly cardinality: 'N:1';
                readonly on: {
                  readonly localFields: readonly ['repliedToId'];
                  readonly targetFields: readonly ['id'];
                };
              };
              readonly replies: {
                ...
                readonly on: {
                  ...
                  readonly targetFields: readonly ['repliedToId'];
                };
              };
            };
            readonly storage: {
              ...
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly posterId: { readonly column: 'posterId' };
                readonly postId: { readonly column: 'postId' };
                readonly repliedToId: { readonly column: 'repliedToId' };
          ...
          readonly Post: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                readonly id: { readonly column: 'id' };
                readonly sourceApi: { readonly column: 'source_api' };
                readonly externalDate: { readonly column: 'external_date' };
          ...
          readonly User: {
            ...
            readonly relations: {
              ...
              readonly comments: {
                ...
                readonly on: {
                  readonly localFields: readonly ['id'];
                  readonly targetFields: readonly ['posterId'];
                };
              };
              readonly sessions: {
                readonly to: {
            ...
            readonly storage: {
              ...
              readonly fields: {
                ...
                readonly displayUsername: { readonly column: 'displayUsername' };
